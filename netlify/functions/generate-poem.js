/**
 * Netlify Function: AI 生成诗接口
 * POST /.netlify/functions/generate-poem
 */
exports.handler = async (event) => {
  ...
  try {
    ...
    const prompt = `根据以下场景信息，创作一首古风诗词：${JSON.stringify(sceneData)}
请返回JSON格式：{ "title": "诗名", "author": "AI", "dynasty": "当代", "content": "完整诗句", "best_line": "最精彩的一句" }`
